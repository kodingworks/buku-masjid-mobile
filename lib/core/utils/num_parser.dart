...
class NumParser {
  /// Parse [int] from dynamic value, e.g., from API.
  ///
  /// Parsing num [int] safely without error, when parsing values.
  ///
  ...
  /// Parse [double] from dynamic value, e.g., from API.
  ///
  /// Parsing num [double] safely without error, when parsing values.
  ///
